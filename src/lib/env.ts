...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_DEFAULT_LAT: z.coerce.number().default(47.6062),
    NEXT_PUBLIC_DEFAULT_LNG: z.coerce.number().default(-122.3321),
    NEXT_PUBLIC_DEFAULT_CITY: z.string().default("Seattle"),
  },
  runtimeEnv: {
